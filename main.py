...
def opts() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--model_name",
        type=str,
        default="deit_base_distilled_patch16_384",
        metavar="MOD",
    ...
    parser.add_argument(
        ...
        default=0.0005,
        metavar="W",
        help="SGD weight-decay (default: 0.001)",
    )
    parser.add_argument(
...
def main():
    ...
    model, train_transforms, val_transforms = ModelFactory(args.model_name).get_all()
    if use_cuda:
        print("Using GPU")
        model.cuda()
    else:
    ...
    train_loader = torch.utils.data.DataLoader(
        datasets.ImageFolder(args.data + "/train_images", transform=train_transforms),
